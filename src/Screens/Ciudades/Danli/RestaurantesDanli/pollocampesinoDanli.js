...
const locationsData = [
  {
    title: "Pollo Campesino",
    
    latitude:      14.030706426939986,   
    longitude:  -86.5712771865063,
  },
...
export default function PolloCampesinoDanli() {  // Este solo es el nomre que se usa para importar esta screen dentro de otro o mandar a llamar
  ...
  const images = [
    {
      url: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t1.6435-9/71720207_2610880272310149_8593033986429681664_n.jpg?_nc_cat=105&cb=99be929b-59f725be&ccb=1-7&_nc_sid=730e14&_nc_ohc=bOrS05ELPtcAX-WOcPf&_nc_ht=scontent.fsap8-1.fna&oh=00_AfAWBnb_jlYVDWMNcPIBLNwQha040RacwuHpyV71__-MHQ&oe=64C3B991',
    },
  ];
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Pollo Campesino</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t1.6435-9/57429744_2307522282645951_5543056445433446400_n.jpg?_nc_cat=104&cb=99be929b-59f725be&ccb=1-7&_nc_sid=e3f864&_nc_ohc=AtwbHwomWM0AX9cID8M&_nc_ht=scontent.fsap8-1.fna&oh=00_AfAZVTo8qovY_JSP6VY__hxzrjXNz1Jsvo0XROwKbgqmpQ&oe=64C3AD15' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t1.18169-9/1919646_833698073361720_7720536411556535209_n.jpg?_nc_cat=101&cb=99be929b-59f725be&ccb=1-7&_nc_sid=cdbe9c&_nc_ohc=hYJs7B61R60AX_Dl6p7&_nc_ht=scontent.fsap8-1.fna&oh=00_AfCejgcIzmcuVsJSqovHSRumE8Tn2fjxEI-O6W3ybndEQg&oe=64C3BFF0' }} />
              </View>
...
<View style={styles.container}>
      ...
      <View style={styles.buttonContainer3}>
        <TouchableOpacity activeOpacity={1} onPress={toggleModal}>
          <Image
            source={{ uri: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t1.6435-9/71720207_2610880272310149_8593033986429681664_n.jpg?_nc_cat=105&cb=99be929b-59f725be&ccb=1-7&_nc_sid=730e14&_nc_ohc=bOrS05ELPtcAX-WOcPf&_nc_ht=scontent.fsap8-1.fna&oh=00_AfAWBnb_jlYVDWMNcPIBLNwQha040RacwuHpyV71__-MHQ&oe=64C3B991' }}
            style={styles.imagen}
            resizeMode="cover"
          />
        </TouchableOpacity>
      ...
      <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Dom: 9:00 AM - 9:00 PM</Text>
        </View>
      ...
      <Modal visible={modalVisible} animationType="fade" transparent={true}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/pollocampesinohonduras');
            }}
          >
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('tel: +50499349415');
            }}
          >
