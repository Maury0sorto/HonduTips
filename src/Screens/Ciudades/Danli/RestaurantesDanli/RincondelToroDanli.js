...
const locationsData = [
  {
    title: "El Rincon del Toro",
     
    latitude:     14.028090401750475,    
    longitude:  -86.57775036260341,
  },
...
export default function RincondelToroDanli() {  // Este solo es el nomre que se usa para importar esta screen dentro de otro o mandar a llamar
  ...
  const images = [
    {
      url: 'https://scontent.ftgu3-3.fna.fbcdn.net/v/t39.30808-6/348868678_1007034283524796_6344740429493526381_n.jpg?_nc_cat=110&cb=99be929b-59f725be&ccb=1-7&_nc_sid=730e14&_nc_ohc=oizlYMo8SqwAX_0mPor&_nc_ht=scontent.ftgu3-3.fna&oh=00_AfBNBSRRXGUakDtodTCeMP5626XgQjq7EkQ8W3kpaizbwQ&oe=64A03997',
    },
  ];
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>El Rincón del Toro</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://scontent.ftgu3-4.fna.fbcdn.net/v/t1.6435-9/198129379_4429994440352962_5046612342801106644_n.jpg?_nc_cat=102&cb=99be929b-59f725be&ccb=1-7&_nc_sid=8bfeb9&_nc_ohc=lahWjX1gLvUAX_qcsZU&_nc_ht=scontent.ftgu3-4.fna&oh=00_AfAtWaBINso2iPP6bIQaQdimwfp5C9UpjOFhg57Ad1mMSw&oe=64C2866E' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://scontent.ftgu3-4.fna.fbcdn.net/v/t1.6435-9/167575986_4205502522802156_2444485790745735817_n.jpg?_nc_cat=108&cb=99be929b-59f725be&ccb=1-7&_nc_sid=8bfeb9&_nc_ohc=t5BTukDi4Y8AX8a3WsW&_nc_ht=scontent.ftgu3-4.fna&oh=00_AfCnhUL7MVnUqqMa4W6hqnNUqLRM_DDff8-OeDRwiyLKgg&oe=64C27BD5' }} />
              </View>
...
<View style={styles.container}>
      ...
      <View style={styles.buttonContainer3}>
        <TouchableOpacity activeOpacity={1} onPress={toggleModal}>
          <Image
            source={{ uri: 'https://scontent.ftgu3-3.fna.fbcdn.net/v/t39.30808-6/348868678_1007034283524796_6344740429493526381_n.jpg?_nc_cat=110&cb=99be929b-59f725be&ccb=1-7&_nc_sid=730e14&_nc_ohc=oizlYMo8SqwAX_0mPor&_nc_ht=scontent.ftgu3-3.fna&oh=00_AfBNBSRRXGUakDtodTCeMP5626XgQjq7EkQ8W3kpaizbwQ&oe=64A03997' }}
            style={styles.imagen}
            resizeMode="cover"
          />
        </TouchableOpacity>
      ...
      <Modal visible={modalVisible} animationType="fade" transparent={true}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/profile.php?id=100063965953143&locale=es_LA');
            }}
          >
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('tel: +50433251419');
            }}
          >
