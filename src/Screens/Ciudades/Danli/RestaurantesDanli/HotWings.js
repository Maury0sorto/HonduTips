...
export default function HotWingsDanli() {  // Este solo es el nomre que se usa para importar esta screen dentro de otro o mandar a llamar
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Hot Wings</Text>
