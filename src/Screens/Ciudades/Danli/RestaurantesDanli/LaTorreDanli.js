...
const locationsData = [
  {
    ...
    latitude:     14.028395011494863,      
    longitude:  -86.57555914560308,
  },
...
export default function LaTorreDanli() {  // Este solo es el nomre que se usa para importar esta screen dentro de otro o mandar a llamar
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Torre Fuerte</Text>
