...
const locationsData = [
  {
    title: "Pollos La Cesta",
    
    latitude:      14.030679161541128,   
    longitude:  -86.57112377794517,
  },
...
export default function PolloslaCestaDanli() {  // Este solo es el nomre que se usa para importar esta screen dentro de otro o mandar a llamar
  ...
  const images = [
    {
      url: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t39.30808-6/305809269_524098066382085_4447019183077345961_n.jpg?_nc_cat=110&cb=99be929b-59f725be&ccb=1-7&_nc_sid=730e14&_nc_ohc=2aG6OquPDlIAX-V8hqB&_nc_ht=scontent.fsap8-1.fna&oh=00_AfAnDuU971wmf1GvltfFollAPfx_p-oEit2qHW3R8TRpFw&oe=64A0134E',
    },
  ];
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Pollos La Cesta</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t1.6435-9/71923486_985961581738143_5898070260208107520_n.jpg?stp=dst-jpg_p160x160&_nc_cat=108&cb=99be929b-59f725be&ccb=1-7&_nc_sid=e3f864&_nc_ohc=viHttLmlMssAX9qwlTk&_nc_ht=scontent.fsap8-1.fna&oh=00_AfAH-JN1cs-GapYPPk7sfExcd85RtZKF2Utc5LuPqw7wAQ&oe=64C2BFEF' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t39.30808-6/277721525_1668291523505142_5514921097782999392_n.jpg?stp=dst-jpg_p235x165&_nc_cat=107&cb=99be929b-59f725be&ccb=1-7&_nc_sid=19026a&_nc_ohc=n3GOv6dBUi4AX_DJy0z&_nc_ht=scontent.fsap8-1.fna&oh=00_AfDajf7W8KjV1K6vVHshNeNARr_EMl3ZARug39vTKTk4Og&oe=64A06948' }} />
              </View>
...
<View style={styles.container}>
      ...
      <View style={styles.buttonContainer3}>
        <TouchableOpacity activeOpacity={1} onPress={toggleModal}>
          <Image
            source={{ uri: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t39.30808-6/305809269_524098066382085_4447019183077345961_n.jpg?_nc_cat=110&cb=99be929b-59f725be&ccb=1-7&_nc_sid=730e14&_nc_ohc=2aG6OquPDlIAX-V8hqB&_nc_ht=scontent.fsap8-1.fna&oh=00_AfAnDuU971wmf1GvltfFollAPfx_p-oEit2qHW3R8TRpFw&oe=64A0134E' }}
            style={styles.imagen}
            resizeMode="cover"
          />
        </TouchableOpacity>
      ...
      <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Dom: 7:00 AM - 10:00 PM</Text>
        </View>
      ...
      <Modal visible={modalVisible} animationType="fade" transparent={true}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/PollosLaCesta');
            }}
          >
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('tel: +50432150103');
            }}
          >
