...
const locationsData = [
  {
    ...
    latitude:      14.03141875159777,    
    longitude:  -86.57026857006834,
  },
  {
    title: "Pollolandia 2",
     
    latitude:      14.030616044070197,    
    longitude:  -86.5712269472617,
  },
  {
    title: "Pollolandia 3",
    
    latitude:      14.042131068501803,    
    longitude:  -86.5715736287043,
  },
  {
    title: "Pollolandia 4",
    
    latitude:      14.03199013285439,    
    longitude:  -86.56856841395302,
  },
  {
    title: "Pollolandia 5",
    
    latitude:      14.028986682407016,    
    longitude:  -86.57266289521556,
  },
...
export default function PolloLandiaDanli() {  // Este solo es el nomre que se usa para importar esta screen dentro de otro o mandar a llamar
  ...
  const images = [
    {
      url: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t1.6435-9/103374852_114145836998195_814864197831619026_n.jpg?_nc_cat=102&cb=99be929b-59f725be&ccb=1-7&_nc_sid=8bfeb9&_nc_ohc=EwvmuiG0-1cAX8JhZsD&_nc_ht=scontent.fsap8-1.fna&oh=00_AfAsm1ZQGS2EJS6vQPJ_DwlF2ioizFPGbVgGS1nOhCC09A&oe=64C29A16',
    },
  ];
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Pollolandia</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t39.30808-6/300370356_522619516335436_6856295076070890688_n.jpg?_nc_cat=104&cb=99be929b-59f725be&ccb=1-7&_nc_sid=e3f864&_nc_ohc=KhXUmwr3hZIAX_BYT57&_nc_ht=scontent.fsap8-1.fna&oh=00_AfBbdRY4s837CadbsIPdpgRRmrNpcUX_GVy9W0amQpJ3QA&oe=64A07F56' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t39.30808-6/344419957_539144291514779_9155347709612557100_n.png?stp=dst-jpg&_nc_cat=110&cb=99be929b-59f725be&ccb=1-7&_nc_sid=19026a&_nc_ohc=MJJvWTUD_ecAX_2_4QY&_nc_ht=scontent.fsap8-1.fna&oh=00_AfBec3Alh4ZEXGLNR3vQOK6M54rTJgP_GwPG_WD45rDXig&oe=64A020F4' }} />
              </View>
...
<View style={styles.container}>
      ...
      <View style={styles.buttonContainer3}>
        <TouchableOpacity activeOpacity={1} onPress={toggleModal}>
          <Image
            source={{ uri: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t1.6435-9/103374852_114145836998195_814864197831619026_n.jpg?_nc_cat=102&cb=99be929b-59f725be&ccb=1-7&_nc_sid=8bfeb9&_nc_ohc=EwvmuiG0-1cAX8JhZsD&_nc_ht=scontent.fsap8-1.fna&oh=00_AfAsm1ZQGS2EJS6vQPJ_DwlF2ioizFPGbVgGS1nOhCC09A&oe=64C29A16' }}
            style={styles.imagen}
            resizeMode="cover"
          />
        </TouchableOpacity>
      ...
      <Modal visible={modalVisible} animationType="fade" transparent={true}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/media/set/?set=a.552845966873346&type=3');
            }}
          >
