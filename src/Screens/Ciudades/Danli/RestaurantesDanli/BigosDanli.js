...
const locationsData = [
    {
        ...
        latitude:      14.027629193378838,  
        longitude:  -86.58002722883543,
      },{
        title: "Bigos 2",
        
        latitude:      14.030982317531652,   
        longitude:  -86.5684645202742,
      },
...
export default function BigosDanli() {  // Este solo es el nomre que se usa para importar esta screen dentro de otro o mandar a llamar
  ...
  const images = [
    {
      url: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t39.30808-6/354973838_648671840630494_3287099071748588789_n.jpg?_nc_cat=108&cb=99be929b-59f725be&ccb=1-7&_nc_sid=730e14&_nc_ohc=X08KP1T5_VsAX9lZXWY&_nc_oc=AQmyKcUXvfe-Jcn_xK3VggWKem_y4dtZM3PrqpWRF4G5R1oX-xO4V8UMgiblYpWAUGY&_nc_ht=scontent.fsap8-1.fna&oh=00_AfAYd_t2pCG13l37hElFMVfA8ifypGzQ0ALocz-PueEmow&oe=64A0C324',
    },
  ];
  ...
  const initialRegion = {
    ...
    latitude:      14.028991610726672,  
    longitude:  -86.57396967689513,
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Bigos</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t1.6435-9/29261794_1969504543078358_3334676208490119168_n.jpg?_nc_cat=106&cb=99be929b-59f725be&ccb=1-7&_nc_sid=cdbe9c&_nc_ohc=YoaFL64LptEAX8a6ESM&_nc_ht=scontent.fsap8-1.fna&oh=00_AfDQME8L74wC9jl2PbJG8KHK0dBaE6189E2anbOw54BDnA&oe=64C3A97D' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t39.30808-6/332236103_3703608366533185_3741849990775673162_n.jpg?_nc_cat=111&cb=99be929b-59f725be&ccb=1-7&_nc_sid=8bfeb9&_nc_ohc=LnTZdBix04UAX_6qAOH&_nc_ht=scontent.fsap8-1.fna&oh=00_AfDV7lHdani_sUhhnynsKIJ0W8gqB9RKozsMElrribrjxQ&oe=64A17A93' }} />
              </View>
...
<View style={styles.container}>
      ...
      <View style={styles.buttonContainer3}>
        <TouchableOpacity activeOpacity={1} onPress={toggleModal}>
          <Image
            source={{ uri: 'https://scontent.fsap8-1.fna.fbcdn.net/v/t39.30808-6/354973838_648671840630494_3287099071748588789_n.jpg?_nc_cat=108&cb=99be929b-59f725be&ccb=1-7&_nc_sid=730e14&_nc_ohc=X08KP1T5_VsAX9lZXWY&_nc_oc=AQmyKcUXvfe-Jcn_xK3VggWKem_y4dtZM3PrqpWRF4G5R1oX-xO4V8UMgiblYpWAUGY&_nc_ht=scontent.fsap8-1.fna&oh=00_AfAYd_t2pCG13l37hElFMVfA8ifypGzQ0ALocz-PueEmow&oe=64A0C324' }}
            style={styles.imagen}
            resizeMode="cover"
          />
        </TouchableOpacity>
      ...
      <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Dom: 7:00 AM - 9:00 PM</Text>
        </View>
      ...
      <Modal visible={modalVisible} animationType="fade" transparent={true}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.bigoshn.com/');
            }}
          >
