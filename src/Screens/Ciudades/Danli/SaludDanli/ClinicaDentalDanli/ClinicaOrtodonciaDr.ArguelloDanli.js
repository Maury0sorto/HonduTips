...
const locationsData = [
  {
    title: "Clinica Ortodoncia",
 
    latitude:  14.027349844400813,
    longitude:   -86.57959029980616,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function ClinicaOrtodonciaArguello() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Clínica de Ortodoncia Argüello</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/jHDXyqV.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vie: 8:00 AM - 5:00 PM </Text>
        </View>
        
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sáb: 10:00 AM - 3:00 PM  </Text>
        </View>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://clinica-de-ortodoncia-dra-rosalba-arguello.negocio.site/');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.027349844400813, -86.57959029980616,)}
          >
            <Text style={styles.buttonText2}>Clínica de Ortodoncia</Text>
          </TouchableOpacity>
        </View>
