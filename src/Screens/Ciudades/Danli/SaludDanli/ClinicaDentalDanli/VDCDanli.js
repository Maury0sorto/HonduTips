...
const locationsData = [
  {
    ...
    latitude:   14.015098827737344, 
    longitude:  -86.57038431247217,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function VCDDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>VCD Especialidades Dentales</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/H8hyCKP.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/VDCespecialidadesdentales/');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.015098827737344, -86.57038431247217,)}
          >
            <Text style={styles.buttonText2}>VCD</Text>
          </TouchableOpacity>
        </View>
