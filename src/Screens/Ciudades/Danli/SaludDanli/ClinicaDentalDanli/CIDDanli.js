...
const locationsData = [
  {
    ...
    latitude:   14.027736085419187, 
    longitude:  -86.56994111521207,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function CIDDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Centro Integral Dental CID</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/KWhNZNl.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://clinicadentalintegral.biz.site/');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.027736085419187, -86.56994111521207,)}
          >
            <Text style={styles.buttonText2}>CID</Text>
          </TouchableOpacity>
        </View>
