...
const locationsData = [
  {
    title: "Clinica Dental Mayorquin",
 
    latitude:   14.02997091826896, 
    longitude:   -86.57816291638899,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function ClinicaDentalMayorquinDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Clinica Dental Mayorquin</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/8fTvOiN.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://sites.google.com/view/clinica-dental-mayorquin/inicio');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.02997091826896, -86.57816291638899,)}
          >
            <Text style={styles.buttonText2}>Clinica Dental Mayorquin</Text>
          </TouchableOpacity>
        </View>
