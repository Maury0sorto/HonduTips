...
const locationsData = [
  {
    ...
    latitude: 14.033360935291716, 
    longitude:  -86.56690484090136,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function CioDentalDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>CIO Dental</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/pN48SKp.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vie: 8:00 AM - 3:00 PM </Text>
        </View>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/Ciodentalclinicaintegralodontologica?locale=hi_IN');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.033360935291716, -86.56690484090136,)}
          >
            <Text style={styles.buttonText2}>CIO</Text>
          </TouchableOpacity>
        </View>
