...
const locationsData = [
  {
    ...
    latitude:  14.030769361631096,
    longitude:   -86.57770398371437,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function CDDentalDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>C&D Dental</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/U3HeUEI.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/profile.php?id=100048818478736');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.030769361631096, -86.57770398371437,)}
          >
            <Text style={styles.buttonText2}>C&D</Text>
          </TouchableOpacity>
        </View>
