...
const locationsData = [
  {
    title: 'Hospital Regional de Oriente Gabriela Alvarado',
    
    latitude:   13.99151215897534, 
    longitude:  -86.56810469912793,
  },
  {
    title: 'Centro de Salud Gabriela Alvarado',
   
    latitude:  14.036059530988968, 
    longitude: -86.57267035415309,
  },
  // Agrega más ubicaciones aquí si lo deseas
];

export default function HospitalGabrielaAlvaradoDanli() {
  const mapRef = useRef(null);
  const initialRegion = {
    latitude:  14.022564517054, 
    longitude: -86.56965871113212,
    latitudeDelta: 0.09,
    longitudeDelta: 0.09,
  };
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Hospital Gabriela Alvarado</Text>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vie: Abierto 24H </Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sáb: Abierto 24H </Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Dom: Abierto 24H</Text>
        </View>
      </View>
