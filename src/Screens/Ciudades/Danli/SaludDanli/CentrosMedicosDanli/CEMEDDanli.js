...
const locationsData = [
  {
    ...
    latitude:    14.032148997843601, 
    longitude:  -86.57132291250689,
  },
 
  // Agrega más ubicaciones aquí si lo deseas
];

export default function CEMEDDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>CEMED</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(14.032148997843601, -86.57132291250689,)}
          >
            <Text style={styles.buttonText2}>CEMED</Text>
          </TouchableOpacity>
        </View>
