...
const locationsData = [
  {
    title: 'Clinicas Medicas Danlí',
    
    latitude:  14.0333043270376, 
    longitude:  -86.58329884314985,
  },
 
  // Agrega más ubicaciones aquí si lo deseas
];

export default function ClinicasMedicasDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}> Clinicas Medicas Danlí </Text>
          ...
          <View style={styles.swiperContainer}>
            ...
            >
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/IfvLnZ8.png' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/IfvLnZ8.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/profile.php?id=100063495282561');
            }}
          >
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(14.0333043270376, -86.58329884314985,)}
          >
