...
const locationsData = [
  {
    ...
    latitude:    14.023314477799419, 
    longitude:  -86.5747444462412,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function IHSSDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>IHS Danli</Text>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vie: 5:00 AM - 7:00 PM </Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.023314477799419, -86.5747444462412,)}
          >
            <Text style={styles.buttonText2}>IHSS</Text>
          </TouchableOpacity>
        </View>
