...
const locationsData = [
  {
    title: 'Centro Medico Quirurgico De Oriente',
    
    latitude:    14.029121630520388, 
    longitude:  -86.57787413255245,
  },
 
  // Agrega más ubicaciones aquí si lo deseas
];

export default function CentroMedicoQuirurgicoDeOriendeDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Centro Medico Quirurgico De Oriente</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.029121630520388, -86.57787413255245,)}
          >
            <Text style={styles.buttonText2}>Centro Medico</Text>
          </TouchableOpacity>
        </View>
