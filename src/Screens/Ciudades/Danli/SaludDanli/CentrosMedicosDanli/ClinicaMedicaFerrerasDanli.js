...
const locationsData = [
  {
    title: 'Clinicas Medicas Ferreras Danlí',
    
    latitude:   14.028345022831077, 
    longitude:  -86.57800400017777,
  },
 
  // Agrega más ubicaciones aquí si lo deseas
];

export default function ClinicaMedicaFerrerasDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}> Clinica Medica Ferrera's  </Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vie: 8:00 AM - 3:30 PM </Text>
        </View>

        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sab: 9:00 AM - 12:00 PM </Text>
        </View>
        ...
        <View style={styles.buttonContainer}> 
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('tel: 98030-5946');
            }}
          >
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.028345022831077, -86.57800400017777,)}
          >
