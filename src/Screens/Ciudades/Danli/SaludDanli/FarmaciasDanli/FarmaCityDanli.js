...
const locationsData = [
  {
    title: "Farmacity",
    latitude:    14.030055209255492, 
    longitude:  -86.56937512359951,
  },
  {
    title: "Farmacity",
    latitude:     14.02772755790069, 
    longitude:   -86.579126121217,
  },
...
export default function FarmacityDanli() {
  const mapRef = useRef(null);
  const initialRegion = {
    latitude:  14.028742600643584, 
    longitude:  -86.57368921837954, 
    latitudeDelta: 0.01,
    longitudeDelta: 0.01,
  };
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Farmacity</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sáb: 8:00 AM - 8:00 PM</Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
        ...
        <View style={styles.buttonContainer}> 
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.farmacity.com/');
            }}
          >
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.030055209255492, -86.56937512359951,)}
          >
            <Text style={styles.buttonText2}>Farmacity 1</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.button2}
            onPress={() => openGoogleMaps( 14.02772755790069, -86.579126121217,)}
          >
            <Text style={styles.buttonText2}>Farmacity 2</Text>
          </TouchableOpacity>
        </View>
