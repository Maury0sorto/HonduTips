...
const locationsData = [
  {
    title: "Farmacia Regis Millenium",
    latitude:   14.042285352378302, 
    longitude:  -86.57165337009481,
  },
 
  {
    title: "Farmacia Regis Terminal",
    latitude:  14.031868134880645, 
    longitude:  -86.57747883537834,
  },
...
export default function FarmaRegisDanli() {
  const mapRef = useRef(null);
  const initialRegion = {
    latitude: 14.039407224824226,
    longitude:  -86.57440759860876,
    latitudeDelta: 0.02,
    longitudeDelta: 0.02,
  };
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Farmacia Regis</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/pqkkSyd.jpg' }} />
              </View>
                <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/O1PPu6Z.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vie: 8:00 AM - 6:00 PM</Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
        ...
        <View style={styles.buttonContainer}> 
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('http://www.farmaciaregis.hn/');
            }}
          >
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.042285352378302, -86.57165337009481,)}
          >
            <Text style={styles.buttonText2}>Farmacia Regis 1</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.button2}
            onPress={() => openGoogleMaps( 14.031868134880645, -86.57747883537834,)}
          >
            <Text style={styles.buttonText2}>Farmacia Regis 2</Text>
          </TouchableOpacity>
        </View>
