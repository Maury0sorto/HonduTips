...
const locationsData = [
  {
    title: "FarmaFácil",
    latitude:   14.04102417100006, 
    longitude:  -86.57025439701452,
  },
...
export default function FarmaFacilDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>FarmaFácil</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/4XFdcUB.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/DzjigOZ.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}> 
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/FarmaF%C3%A1cil-Honduras-103443005846901/');
            }}
          >
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.04102417100006, -86.57025439701452,)}
          >
            <Text style={styles.buttonText2}>FarmaFácil</Text>
          </TouchableOpacity>
        </View>
