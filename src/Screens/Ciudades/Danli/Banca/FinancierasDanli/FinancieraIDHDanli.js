...
const locationsData = [
  {
    title: 'Financiera IDH',
    latitude:   14.030433690394023, 
    longitude:  -86.56695768321192,
  },
  
  // Agrega más ubicaciones aquí si lo deseas
];

export default function FinancieraIDHDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>IDH</Text>
          ...
          <View style={styles.swiperContainer}>
            ...
            >
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/Nrm1DQO.png' }} />
              </View>
            </Swiper>
          </View>
        </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.idhmicrofinanciera.hn/');
            }}
          >
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.030433690394023, -86.56695768321192,)}
          >
