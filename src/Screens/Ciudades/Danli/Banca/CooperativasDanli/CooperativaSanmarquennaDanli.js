...
const locationsData = [
  {
    title: 'Cooperativa Sanmarqueña',
    latitude:   14.029180292418397, 
    longitude:  -86.56927987026255,
  },
  
  // Agrega más ubicaciones aquí si lo deseas
];

export default function CooperativaSanmarqueñaDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Cooperativa Sanmarqueña</Text>
          ...
          <View style={styles.swiperContainer}>
            ...
            >
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/fVOLk6Q.png' }} />
              </View>
            </Swiper>
          </View>
        </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.sanmarquena.com/');
            }}
          >
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://api.whatsapp.com/send?phone=9420-3162');
            }}
          >
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.029180292418397, -86.56927987026255,)}
          >
