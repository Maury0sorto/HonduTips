...
const locationsData = [
  {
    title: 'Cooperativa Sagrada Familia',
    latitude:  14.031437387365989, 
    longitude:  -86.56698911052213,
  },
  
  // Agrega más ubicaciones aquí si lo deseas
];

export default function CooperativaSagradaFamiliaDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Cooperativa Sagrada Familia</Text>
          ...
          <View style={styles.swiperContainer}>
            ...
            >
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/vZ1zZAj.png' }} />
              </View>
            </Swiper>
          </View>
        </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://sagradafamilia.hn/?fbclid=IwAR0HJRRm8UFmyajFh32j0wrJn3NZjWBrvf7jUmIAAw3Yfd_bgjTvrYK4kYQ');
            }}
          >
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://api.whatsapp.com/send?phone=9452-1627');
            }}
          >
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.031437387365989, -86.56698911052213,)}
          >
