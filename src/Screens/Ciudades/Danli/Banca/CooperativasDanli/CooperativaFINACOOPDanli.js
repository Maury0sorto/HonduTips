...
const locationsData = [
  {
    ...
    latitude:   14.02944911205275, 
    longitude:  -86.56832838027675,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function CooperativaFINACOOPDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Cooperativa FINACOOP</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/kErpez3.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/MrBOlme.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.finacoop.hn/');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.02944911205275, -86.56832838027675,)}
          >
            <Text style={styles.buttonText2}> FINACOOP </Text>
          </TouchableOpacity>
        </View>
