...
const locationsData = [
  {
    ...
    latitude: 14.023544410580755,
    longitude: -86.56637583277819,
  },
  {
    title: 'Banco Azteca',
    description: 'Descripción de Tegucigalpa',
          ...
          <View style={styles.swiperContainer}>
            ...
            >
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/lKBjnhj.jpg' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://elceo.com/wp-content/uploads/2023/05/servicios-bancoazteca2.jpg' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.bancoazteca.com.hn/PortalHonWeb/');
            }}
          >
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('tel: +504 2280 6800');
            }}
          >
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.023544410580755, -86.56637583277819,)}
          >
            <Text style={styles.buttonText2}>Banco Azteca</Text>
          </TouchableOpacity>
        </View>
