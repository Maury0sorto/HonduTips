...
export default function Bancopopular() {
  ...
  return (
    <ScrollView>
          ...
          <View style={styles.swiperContainer}>
            ...
            >
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://bancopopular.hn/wp-content/uploads/2018/10/dANLI.png' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://bancopopular.hn/wp-content/uploads/2020/03/Megamall.jpg' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Dom: 8:00 AM - 4:30 PM</Text>
        </View>
      </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://bancopopular.hn/');
            }}
          >
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(14.029686052273089, -86.57099896136066,)}
          >
            <Text style={styles.buttonText2}>Banco Popular</Text>
          </TouchableOpacity>
        </View>
