          ...
          <View style={styles.swiperContainer}>
            ...
            >
              ...
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/u29Cccb.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/vCYWpwB.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.029546951256442,  -86.57207043024235,)}
          >
            <Text style={styles.buttonText2}>BAC</Text>
          </TouchableOpacity>
        </View>
