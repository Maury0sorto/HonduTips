      ...
      <View style={styles.container}>
        ...
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://www.banpais.hn/wp-content/uploads/2019/04/20190318_100813-1024x498.jpg' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://www.banpais.hn/wp-content/uploads/2019/01/Image-Calidad.jpg' }} />
              </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.banpais.hn/');
            }}
          >
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://api.whatsapp.com/send?phone=50425451212');
            }}
          >
