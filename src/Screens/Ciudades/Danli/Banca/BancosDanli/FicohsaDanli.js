...
const locationsData = [
  {
    ...
    latitude:  14.029492700265148, 
    longitude:  -86.56819516484332,
  },
  
  // Agrega más ubicaciones aquí si lo deseas
];

export default function FicohsaDanli() {
  const mapRef = useRef(null);
  const initialRegion = {
    latitude:  14.029537631675582, 
    longitude: -86.56825005036595,
    latitudeDelta: 0.004,
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Banco Ficohsa</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.ytimg.com/vi/7phMHhxl3fA/maxresdefault.jpg' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://sucursales.net/wp-content/uploads/2023/02/Houston-Tx-83.jpg' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://proceso.hn/wp-content/uploads/2022/10/Ficohsa-Global-Finance.jpg' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.029470222153076, -86.5681944609281,)}
          >
            <Text style={styles.buttonText2}>Banco Ficohsa</Text>
          </TouchableOpacity>
