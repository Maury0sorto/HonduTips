...
const locationsData = [
  {
    title: 'Banco de los Trabajadores',
 
    latitude:   14.031412510893253, 
    longitude:  -86.56675590118076,
  },
  
  // Agrega más ubicaciones aquí si lo deseas
];

export default function BANTRABDanli() {
  const mapRef = useRef(null);
  const initialRegion = {
    latitude:   14.030657436240169,  
    longitude: -86.56672132319201,
    latitudeDelta: 0.01,
    longitudeDelta: 0.01,
  };
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>BanTrab</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://mallgaleriashn.com/themes/galerias/assets/images/logos/stores/bantrab.jpg' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://www.cotizacion.co/img/casas-de-cambio/ChIJ3_2uEzNobo8RBEyaJP0nmlg.jpg' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.bantrab.hn/');
            }}
          >
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.030657436240169, -86.56672132319201,)}
          >
            <Text style={styles.buttonText2}>BANTRAB</Text>
          </TouchableOpacity>
        </View>
