...
export default function BancoOccidenteDanli() {
        ...
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://www.prestamospersonales.pro/wp-content/uploads/2020/08/Banco-de-Occidente-Honduras.png' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://lh3.googleusercontent.com/p/AF1QipPtPyemqjzcJh3DTOiyqLWi3sUxhf_-Q6UaL60o=s1600-w400' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.02878113756771, -86.57113911351507,)}
          >
            <Text style={styles.buttonText2}>Banco Occidente</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.button2}
            onPress={() => openGoogleMaps( 14.032916288694746, -86.57030763560499,)}
          >
            <Text style={styles.buttonText2}>Banco Occidente Sucursal</Text>
          </TouchableOpacity>
