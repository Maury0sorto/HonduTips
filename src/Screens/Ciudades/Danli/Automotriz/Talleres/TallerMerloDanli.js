...
export default function TallerMerloDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Taller Mecanico Merlo</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/noT4Duc.jpg' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/8D35juO.jpg' }} />
              </View>
        ...
        <View style={styles.buttonContainer}>
          ...
          >
            <Text style={styles.buttonText2}>Geolocalizar Taller Mecanico Merlo</Text>
          </TouchableOpacity>
        </View>
