...
const locationsData = [
  {
    title: "Taller Auto Electrico El Rey",
 
    latitude:  14.032399230673711,   
    longitude:  -86.57865888045166,
  },
  
  // Agrega más ubicaciones aquí si lo deseas
];

export default function TallerElRey() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Taller Auto Electrico     El Rey</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/j7nJmXZ.jpg' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/va1J2PK.jpg' }} />
              </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.032399230673711,   -86.57865888045166,)}
          >
            <Text style={styles.buttonText2}>Geolocalizar Taller Auto Electrico El Rey</Text>
          </TouchableOpacity>
        </View>
