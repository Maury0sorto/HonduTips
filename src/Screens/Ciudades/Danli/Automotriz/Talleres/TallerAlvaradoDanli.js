...
const locationsData = [
  {
    title: "Taller Mecanico Alvarado",
 
    latitude:  14.033369250702815,  
    longitude:  -86.57610490699004,
  },
  
  // Agrega más ubicaciones aquí si lo deseas
];

export default function TallerAlvaradoDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Taller Mecanico Alvarado</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/Fg2Q7ky.jpg' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/uKj9WmI.jpg' }} />
              </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.033369250702815,  -86.57610490699004,)}
          >
            <Text style={styles.buttonText2}>Geolocalizar Taller Mecanico Alvarado</Text>
          </TouchableOpacity>
        </View>
