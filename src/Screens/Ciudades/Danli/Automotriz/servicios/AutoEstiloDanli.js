        ...
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/GTMfYnt.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/PEpdfBd.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.027700610874744, -86.57952633986953, )}
          >
            <Text style={styles.buttonText2}>Auto Estilo</Text>
          </TouchableOpacity>
        </View>
