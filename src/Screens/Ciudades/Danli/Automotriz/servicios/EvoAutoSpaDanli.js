        ...
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/zCggbxB.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/wDNQy7T.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.033795401709169,    -86.57475286113117, )}
          >
            <Text style={styles.buttonText2}>Evo Auto Spa 1</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.button2}
            onPress={() => openGoogleMaps(  14.021091061055728, -86.57314140179405,  )}
          >
            <Text style={styles.buttonText2}>Evo Auto Spa 2</Text>
          </TouchableOpacity>
        </View>
