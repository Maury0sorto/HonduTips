...
const LubricentrosDanli = () => {
  ...
  const buttons = [
    { text: "Llantiservicios Barpin", image: 'https://i.imgur.com/29AtdCP.jpg',  screen: ScreenA },
    { text: "Auto Estilo", image: 'https://i.imgur.com/1roespq.jpg',  screen: ScreenB },
    { text: "Autopits Romero", image: 'https://i.imgur.com/miKavAV.jpg',  screen: ScreenC },
  ...
  const data2 = [
    ...
    { key: '3', value: "Auto Estilo" },
    { key: '$', value: "Autopits Romero" },
