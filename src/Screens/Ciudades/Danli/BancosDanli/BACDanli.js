...
const locationsData = [
  {
    ...
    latitude:   14.029546951256442, 
    longitude:  -86.57207043024235,
  },
...
export default function BACDanli() {
        ...
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/qfDL0UP.jpg' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://scontent.ftgu2-3.fna.fbcdn.net/v/t39.30808-6/330188122_448235924114027_6014743190269352566_n.png?_nc_cat=108&ccb=1-7&_nc_sid=730e14&_nc_ohc=4EpE4J-16vEAX9OM21w&_nc_ht=scontent.ftgu2-3.fna&oh=00_AfBsV-l53G0dOuWF2ZdOrdTffenZi-FrWseDQzRcur4cSw&oe=64A3146F' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.baccredomatic.com/es-hn');
            }}
          >
