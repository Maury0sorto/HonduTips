...
const BarberiasDanli = () => {
  ...
  const buttons = [
    ...
    { text: 'Barberia Leody', image: 'https://i.imgur.com/3MabvRG.gif', screen: ScreenB },
    { text: 'Mateos Barber Shop', image: 'https://i.imgur.com/3MabvRG.gif', screen: ScreenB },
    { text: 'Barberia Tu Imagen', image: 'https://i.imgur.com/3MabvRG.gif', screen: ScreenB },
    { text: 'Barberia Erick Glamur', image: 'https://i.imgur.com/3MabvRG.gif', screen: ScreenB },
    { text: 'Shadai Master BarberShop', image: 'https://i.imgur.com/3MabvRG.gif', screen: ScreenB },
    { text: 'Evan’s Barber Shop', image: 'https://i.imgur.com/3MabvRG.gif', screen: ScreenB },
