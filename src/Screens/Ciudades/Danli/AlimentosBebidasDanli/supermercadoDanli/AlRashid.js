...
const locationsData = [
  {
    ...
    latitude:     14.031101884854708,       
    longitude:  -86.56924758888785
  },
  {
    title: "Al Rashid #1",
    
    latitude:     14.030810440142588,       
    longitude:   -86.57538448262129
  },
...
export default function AlRashidDanli() {  // Este solo es el nomre que se usa para importar esta screen dentro de otro o mandar a llamar
  ...
  const initialRegion = {
    ...
    latitude:     14.030768805153475,     
    longitude:  -86.57192979768743,
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Supermercados Al Rashid</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/Q4Cal2z.jpg' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/HDJSy3v.jpg' }} />
              </View>
      ...
      <Modal visible={modalVisible} animationType="fade" transparent={true}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('tel: +50427633350');
            }}
          >
