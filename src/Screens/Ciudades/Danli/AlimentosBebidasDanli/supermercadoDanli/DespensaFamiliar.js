...
const locationsData = [
  {
    title: "Despensa Familiar #2",
    
    latitude:     14.047820052591513,      
    longitude:  -86.55555363738623
  },
  {
    title: "Despensa Familiar #1",
    
    latitude:     14.032158514177429,       
    longitude:  -86.56642492782515
  },
...
export default function DespensaDanli() {  // Este solo es el nomre que se usa para importar esta screen dentro de otro o mandar a llamar
  ...
  const initialRegion = {
    ...
    latitude:     14.04198971139139,     
    longitude:  -86.56086072837931,
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Despensa Familiar</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/iRkFh5e.png' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/NR4KZVl.jpg' }} />
              </View>
...
<View style={styles.container}>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Dom: 8:30 AM - 9:00 PM</Text>
        </View>
      </View>
      ...
      <Modal visible={modalVisible} animationType="fade" transparent={true}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('tel: +50487834900');
            }}
          >
