...
const locationsData = [
  {
    ...
    latitude:     14.02871533676559,     
    longitude:  -86.57114752392472 ,
  },
...
export default function MaxiDanli() {  // Este solo es el nomre que se usa para importar esta screen dentro de otro o mandar a llamar
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Maxi Despensa</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/VvBBTdr.jpg' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/UDT4VmT.jpg' }} />
              </View>
