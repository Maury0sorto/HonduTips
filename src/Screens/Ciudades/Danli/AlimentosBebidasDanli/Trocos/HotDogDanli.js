...
const locationsData = [
  {
    title: "Hot Dogs El Chino",
    
    latitude:       14.0296573738419,  
    longitude:  -86.5709254635647,
  },
...
export default function HotDogDanli() {  // Este solo es el nomre que se usa para importar esta screen dentro de otro o mandar a llamar
  ...
  const images = [
    {
      url: 'https://i.imgur.com/SafYTGM.jpg',
    },
  ];
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Hot Dogs El Chino</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/ybEduka.png' }} />
              </View>
...
<View style={styles.container}>
      ...
      <View style={styles.buttonContainer3}>
        <TouchableOpacity activeOpacity={1} onPress={toggleModal}>
          <Image
            source={{ uri: 'https://i.imgur.com/SafYTGM.jpg' }}
            style={styles.imagen}
            resizeMode="cover"
          />
        </TouchableOpacity>
      ...
      <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Dom: 4:00 PM - 12:00 PM</Text>
        </View>
      </View>
