...
const locationsData = [
  {
    title: "Las Colinas Food Truck Park",
    
    latitude:    14.028850533976138,      
    longitude:  -86.575146301788,
  },
...
export default function LasColinasDanli() {  // Este solo es el nomre que se usa para importar esta screen dentro de otro o mandar a llamar
  ...
  const images = [
    {
      url: 'https://i.imgur.com/rRrsHJU.jpg',
    },
  ];
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Las Colinas Food Truck Park</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/PNMMkSJ.jpg' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/llqBVqk.jpg' }} />
              </View>
            </Swiper>
          </View>
        </View>
...
<View style={styles.container}>
      ...
      <View style={styles.buttonContainer3}>
        <TouchableOpacity activeOpacity={1} onPress={toggleModal}>
          <Image
            source={{ uri: 'https://i.imgur.com/rRrsHJU.jpg' }}
            style={styles.imagen}
            resizeMode="cover"
          />
        </TouchableOpacity>
      ...
      <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Dom: 8:00 AM - 11:30 PM</Text>
        </View>
      </View>
      ...
      <Modal visible={modalVisible} animationType="fade" transparent={true}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/lascolinasfoodtruckpark');
            }}
          >
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('tel: +50497765171');
            }}
          >
