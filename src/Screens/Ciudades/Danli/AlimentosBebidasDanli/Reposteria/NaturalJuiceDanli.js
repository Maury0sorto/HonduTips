...
const locationsData = [
  {
    ...
    latitude:     14.031840189820445,      
    longitude:  -86.56700985223478,
  },
  {
    title: "Natural Juice Uniplaza",
...
export default function NaturalJuiceDanli() {  // Este solo es el nomre que se usa para importar esta screen dentro de otro o mandar a llamar
  ...
  const images = [
    {
      url: 'https://i.imgur.com/Qy55G2V.jpg',
    },
  ];
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Natural Juice</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/R1BbDle.png' }} />
              </View>
              <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/6oW8BkV.png' }} />
              </View>
...
<View style={styles.container}>
      ...
      <View style={styles.buttonContainer3}>
        <TouchableOpacity activeOpacity={1} onPress={toggleModal}>
          <Image
            source={{ uri: 'https://i.imgur.com/Qy55G2V.jpg' }}
            style={styles.imagen}
            resizeMode="cover"
          />
        </TouchableOpacity>
      ...
      <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Dom: 8:00 AM - 8:30 PM</Text>
        </View>
      </View>
      ...
      <Modal visible={modalVisible} animationType="fade" transparent={true}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/tgunaturaljuice');
            }}
          >
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('tel: +50497240128');
            }}
          >
