  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Uniplaza Danli</Text>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vie: 9:00 AM - 9:00 PM </Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sáb: 9:00 AM - 9:00 PM </Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Dom: 9:00 AM - 9:00 PM  </Text>
        </View>
      </View>
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.027594621961851, -86.57912792402742,)}
          >
            <Text style={styles.buttonText2}>Uniplaza</Text>
          </TouchableOpacity>
        </View>
