...
const locationsData = [
  {
    title: "Centro Comercial Santa Rita",
 
    latitude:  14.026464451306657, 
    longitude: -86.58352610374097,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function CentroComercialElDoradoDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Centro Comercial El Dorado</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/Aulynel.jpg' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vie: 5:00 AM - 10:00 PM </Text>
        </View>
        
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sáb: 6:00 AM - 9:00 PM </Text>
        </View>
        
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Dom: 6:00 AM - 9:00 PM  </Text>
        </View>
      </View>
    </View>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/eldoradodanli/');
            }} 
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.026435010366336, -86.58352610374097,)}
          >
            <Text style={styles.buttonText2}>Centro Comercial El Dorado</Text>
          </TouchableOpacity>
        </View>
