...
const PlazasComercialesDanli = () => {
  ...
  const buttons = [
    ...
    { text: 'Mall La Cumbre', image: 'https://i.imgur.com/o76d0ai.jpg', screen: ScreenC },
      { text: 'Plaza San Miguel', image: 'https://i.imgur.com/bxG35dW.png', screen: ScreenD },
       { text: 'Plaza Las Colinas', image: 'https://i.imgur.com/heFzUKO.png', screen: ScreenE },
        { text: 'Nova Plaza', image: 'https://i.imgur.com/Cd6Dlh6.png', screen: ScreenF },
