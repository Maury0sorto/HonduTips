...
const locationsData = [
  {
    title: "Edificio Astro",
 
    latitude:   14.030697125174648, 
    longitude:-86.56947939377662,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function EdificioAstroDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Edificio Astro</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.grupoastro.net/index.html');
            }} 
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.030697125174648, -86.56947939377662,)}
          >
            <Text style={styles.buttonText2}>Edificio Astro</Text>
          </TouchableOpacity>
        </View>
