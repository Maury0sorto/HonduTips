...
const locationsData = [
  {
    ...
    latitude:  14.031324484410181, 
    longitude: -86.56976132860216,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function CentroComercialMariaLuisaDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Centro Comercial Maria Luisa</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/centromarialuisa/?locale=es_LA');
            }} 
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.031324484410181, -86.56976132860216,)}
          >
            <Text style={styles.buttonText2}>Centro Comercial Maria Luisa</Text>
          </TouchableOpacity>
        </View>
