  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Mall La Cumbre Danli</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Dom: 9:00 AM - 5:00 PM  </Text>
        </View>
      </View>
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.020743726676715, -86.56997366570069,)}
          >
            <Text style={styles.buttonText2}>Mall La Cumbre</Text>
          </TouchableOpacity>
        </View>
