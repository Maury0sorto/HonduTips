...
const locationsData = [
  {
    ...
    latitude:  14.019071046521512,
    longitude: -86.57283007393013,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function NovaPlazaDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Nova Plaza</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.019071046521512, -86.57283007393013,)}
          >
            <Text style={styles.buttonText2}>Nova Plaza</Text>
          </TouchableOpacity>
        </View>
