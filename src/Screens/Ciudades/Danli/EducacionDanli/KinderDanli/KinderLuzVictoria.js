...
const locationsData = [
  {
    title: "Jardin de Niños Luz Victoria",
 
    latitude: 14.048210573066669, 
    longitude:  -86.56394678954346,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function KinderLuzVictoria() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Jardin de Niños Luz Victoria</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.048210573066669, -86.56394678954346,)}
          >
