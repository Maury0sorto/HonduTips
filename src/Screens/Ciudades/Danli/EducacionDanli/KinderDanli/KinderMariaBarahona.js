...
const locationsData = [
  {
    title: "Kinder Maria Barahona",
 
    latitude:  14.03932000892269,
    longitude:   -86.57106548067429,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function KinderMariaBarahona() {
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.03932000892269, -86.57106548067429,)}
          >
            <Text style={styles.buttonText2}>Kinder Maria Barahona</Text>
          </TouchableOpacity>
        </View>
