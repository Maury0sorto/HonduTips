...
const locationsData = [
  {
    ...
    latitude:  14.035888809274244, 
    longitude:  -86.573171543759,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function JardinDeNinnosDulceInfancia() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Jardin de Niños Dulce Infancia</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/uJDtWHr.png' }} />
              </View>
                 <View style={styles.slide}>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/profile.php?id=100057667232172&locale=es_LA');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.035866543853446, -86.57311791450962,)}
          >
            <Text style={styles.buttonText2}>Jardin de Niños</Text>
          </TouchableOpacity>
        </View>
