...
const locationsData = [
  {
    title: "Instituto Cosme Garcia",
 
    latitude: 14.023395433114676, 
    longitude:  -86.56998547948719,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function InstitutoCosmeGarcia() {
    ...
    <ScrollView>
        ...
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/BvMp8ck.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/5eqYkOo.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/CGCoficial?locale=es_LA');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.023395433114676, -86.56998547948719,)}
          >
