...
const locationsData = [
  {
    title: "Instituto Departamental de Oriente",
 
    latitude: 14.036373344866973, 
    longitude:  -86.57610324846537,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function IDODanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Instituto Departamental de Oriente</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.036373344866973, -86.57610324846537,)}
          >
            <Text style={styles.buttonText2}>Colegio</Text>
          </TouchableOpacity>
        </View>
