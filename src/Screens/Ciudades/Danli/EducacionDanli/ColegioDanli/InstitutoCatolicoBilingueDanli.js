...
const locationsData = [
  {
    title: "Instituto Catolico Billingüe",
 
    latitude: 14.02459298665125, 
    longitude:   -86.57954688747061,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function InstiutoCatolicoBillingüe() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Instituto Católico Bilingüe</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.024630062553806, -86.57954688747061,)}
          >
