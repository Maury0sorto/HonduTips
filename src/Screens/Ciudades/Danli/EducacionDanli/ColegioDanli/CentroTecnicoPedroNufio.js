...
const locationsData = [
  {
    title: "Centro Tecnico Pedro Nufio",
 
    latitude: 14.011966273530586, 
    longitude:   -86.56954688502357,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function CentroTecnicoPedroNufio() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Centro Tecnico Pedro Nufio</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/39AlCtA.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/FKdIiLz.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sab-Dom: Cerrado</Text>
        </View>
      </View>
    </View>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/intao.oriente.1?locale=es_LA');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.011966273530586, -86.56954688502357,)}
          >
