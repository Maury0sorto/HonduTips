...
const locationsData = [
  {
    ...
    latitude: 14.031316636788985, 
    longitude: -86.56428212780294,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function UniversidadPolitecnica() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Universidad Politécnica</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/1MA5D4e.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/DDDk95c.jpg' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.031316636788985, -86.56428212780294,)}
          >
