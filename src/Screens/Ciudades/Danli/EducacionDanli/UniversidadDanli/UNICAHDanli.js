...
const locationsData = [
  {
    ...
    latitude: 14.025494820659022, 
    longitude: -86.5818138694612,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function UNICAHSAP() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>UNICAH SAP</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/MEYQ0DJ.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/vzlW1Kh.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vier: 7:00 AM - 9:00 PM</Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sab: 8:00 AM - 5:00 PM</Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('http://www.unicah.edu/');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.025494820659022, -86.5818138694612,)}
          >
            <Text style={styles.buttonText2}>UNICAH</Text>
          </TouchableOpacity>
        </View>
