...
const locationsData = [
  {
    title: "Escuela Manuel Adalid Gamero",
 
    latitude:  14.030156142963946, 
    longitude:  -86.56862557928342,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function EscuelaManuelAdalidGamero() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Escuela Manuel Adalid y Gamero</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/TVeaJTy.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/TVeaJTy.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/EMAG2021?locale=es_LA');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.030156142963946, -86.56862557928342,)}
          >
