...
const locationsData = [
  {
    title: "Escuela Pedro Nufio",
 
    latitude:  14.030609513485778, 
    longitude:  -86.56401847872091,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function EscuelaPedroNufio() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Escuela Pedro Nufio</Text>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vier: 7:00 AM - 5:00 PM</Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.030609513485778, -86.56401847872091,)}
          >
