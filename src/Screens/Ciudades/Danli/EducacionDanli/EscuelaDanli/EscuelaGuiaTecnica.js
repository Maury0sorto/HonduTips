...
const locationsData = [
  {
    title: "Escuela Guia Tecnica",
 
    latitude:  14.037771620941136, 
    longitude:  -86.57298519172136,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function EscuelaGuiaTecnica() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Escuela Guia Tecnica #10</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/qBFxJhZ.png' }} />
              </View>
                 <View style={styles.slide}>
                 <Image style={styles.image} source={{ uri: 'https://i.imgur.com/fprQ1om.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://evalizetharriola15.wixsite.com/guia-tecnica/our-school');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.037771620941136, -86.57298519172136,)}
          >
