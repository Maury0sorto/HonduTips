...
const locationsData = [
  {
    title: "Escuela San Luis",
 
    latitude:  14.031674393194198, 
    longitude:  -86.56584868050695,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function EscuelaSanLuis() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Escuela San Luis</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/cFqABBs.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/kSSXsxi.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.031674393194198, -86.56584868050695,)}
          >
