...
const locationsData = [
  {
    ...
    latitude:  14.00755516514115, 
    longitude:  -86.58036981994145,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function ChildrensWolrdSchool() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>The Children's World School</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.tcws.edu.hn/');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.00755516514115, -86.58036981994145,)}
          >
