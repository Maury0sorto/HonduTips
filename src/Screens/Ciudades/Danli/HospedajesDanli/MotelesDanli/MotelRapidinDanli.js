...
const locationsData = [
  {
    ...
    latitude:  14.0230808935141, 
    longitude:  -86.59211852489915,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function MotelRapidinDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Motel RAPID-INN</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/AMxZ0F4.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/AMxZ0F4.png' }} />
              </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.0230808935141, -86.59211852489915,)}
          >
            <Text style={styles.buttonText2}>RAPID-INN</Text>
          </TouchableOpacity>
        </View>
