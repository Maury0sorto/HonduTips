...
const locationsData = [
  {
    title: "Auto Hotel San Marquez",
 
    latitude:    13.973574313785084, 
    longitude:  -86.56463406841429,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function AutoHotelSanMarquezDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Auto Hotel San Marquez</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/ARnb4FD.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/ARnb4FD.png' }} />
              </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  13.973574313785084, -86.56463406841429,)}
          >
            <Text style={styles.buttonText2}>Auto Hotel San Marquez</Text>
          </TouchableOpacity>
        </View>
