...
const locationsData = [
  {
    title: "Motel La Fuente",
 
    latitude:  14.019552153134665, 
    longitude:  -86.62474909480234,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function MotelLaFuenteDanli() {
  ...
  const images = [
    {
      url: 'https://i.imgur.com/9kknn98.png',
    },
  ];
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Motel La Fuente</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/a9XzNqj.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/a9XzNqj.png' }} />
              </View>
      ...
      <View style={styles.buttonContainer3}>
        <TouchableOpacity activeOpacity={1} onPress={toggleModal}>
          <Image
            source={{ uri: 'https://i.imgur.com/9kknn98.png' }}
            style={styles.imagen}
            resizeMode="cover"
          />
        </TouchableOpacity>
      ...
      <Modal visible={modalVisible} animationType="fade" transparent={true}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/profile.php?id=100038760174405');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.019552153134665, -86.62474909480234,)}
          >
            <Text style={styles.buttonText2}>Motel La Fuente</Text>
          </TouchableOpacity>
        </View>
