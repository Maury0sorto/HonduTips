...
const locationsData = [
  {
    ...
    latitude:     14.028940563984087, 
    longitude:  -86.57289504750966,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function HotelElCastilloDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Hotel El Castillo</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/gVP2vIa.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/TrFHqRg.png' }} />
              </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/profile.php?id=100063007430635');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.028940563984087, -86.57289504750966,)}
          >
            <Text style={styles.buttonText2}>Hotel El Castillo</Text>
          </TouchableOpacity>
        </View>
