...
const locationsData = [
  {
    ...
    latitude:      14.030911053178423,
    longitude:   -86.57064707424848,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function HotelMilayFDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Hotel Milay F</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/MxdCkZn.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/MxdCkZn.png' }} />
              </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.030911053178423, -86.57064707424848,)}
          >
            <Text style={styles.buttonText2}>Hotel Milay F</Text>
          </TouchableOpacity>
        </View>
