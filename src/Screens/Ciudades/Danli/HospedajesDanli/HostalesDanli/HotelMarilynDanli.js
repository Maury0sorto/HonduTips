...
const locationsData = [
  {
    ...
    latitude:   14.032813099077227, 
    longitude:   -86.5784861078422,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function HotelMarilynDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Hotel Marilyn</Text>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.032813099077227, -86.5784861078422,)}
          >
            <Text style={styles.buttonText2}>Hotel Marilyn</Text>
          </TouchableOpacity>
        </View>
