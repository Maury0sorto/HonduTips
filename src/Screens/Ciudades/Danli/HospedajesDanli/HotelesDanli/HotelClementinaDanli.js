...
const locationsData = [
  {
    title: "Hotel Clementina",
 
    latitude:     14.038163601275752, 
    longitude:   -86.57684963464811,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function HotelClementinaDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Hotel Clementina</Text>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/profile.php?id=100069310840823');
            }}
          >
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.038163601275752,  -86.57684963464811,)}
          >
