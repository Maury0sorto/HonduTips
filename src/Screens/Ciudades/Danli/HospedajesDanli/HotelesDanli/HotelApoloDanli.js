...
const locationsData = [
  {
    ...
    latitude:    14.029310313938277,  
    longitude:   -86.56966414403837,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function HotelApoloDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Hotel Apolo</Text>
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.029310313938277,  -86.56966414403837,)}
          >
