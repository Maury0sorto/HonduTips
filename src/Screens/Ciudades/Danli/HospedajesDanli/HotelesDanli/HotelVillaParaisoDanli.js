...
const locationsData = [
  {
    title: "Hotel Villa Paraiso",
 
    latitude:     14.02020083534463, 
    longitude:   -86.5698630471626,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function HotelVillaParaisoDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Hotel Villa Paraíso</Text>
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.02020083534463, -86.5698630471626,)}
          >
