...
const locationsData = [
  {
    title: "Hotel La Esperanza",
 
    latitude:    14.029938509552023, 
    longitude:   -86.57045755269296,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function HotelLaEsperanzaDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Hotel La Esperanza</Text>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/pages/Hotel-La-Esperanza-Danli/156114284523317');
            }}
          >
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.029938509552023, -86.57045755269296,)}
          >
