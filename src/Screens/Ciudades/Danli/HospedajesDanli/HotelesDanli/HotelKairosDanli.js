...
const locationsData = [
  {
    ...
    latitude:   14.03018191502633, 
    longitude:   -86.56938984005279,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function HoltelKairos() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Hotel Kairos</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/gV5DIQ3.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/gV5DIQ3.png' }} />
              </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/profile.php?id=100063635855869');
            }}
          >
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.03018191502633, -86.56938984005279)}
          >
            <Text style={styles.buttonText2}>Hotel</Text>
          </TouchableOpacity>
        </View>
