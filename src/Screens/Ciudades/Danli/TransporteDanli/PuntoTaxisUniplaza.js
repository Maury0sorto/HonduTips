...
const locationsData = [
  {
    ...
    latitude:  14.027879398108887,
    longitude: -86.57919056586476,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function PuntoTaxisUniplaza() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Punto de Taxis Uniplaza</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.027879398108887, -86.57919056586476,)}
          >
            <Text style={styles.buttonText2}>Punto de Taxis Uniplaza</Text>
          </TouchableOpacity>
        </View>
