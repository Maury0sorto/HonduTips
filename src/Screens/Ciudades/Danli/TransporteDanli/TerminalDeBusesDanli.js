...
const locationsData = [
  {
    ...
    latitude:  14.031186171770436, 
    longitude: -86.57769372459589,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function TerminalBusesDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Terminal de Buses</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/GzUwD1C.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/6sj3grl.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vie: 6:00 AM - 6:00 PM </Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sáb: 6:00 AM - 5:00 PM </Text>
        </View>
        
        <View style={styles.scheduleItem}> 
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Dom: 6:00 AM - 12:00 PM</Text>
        </View>
      </View>
    </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.031186171770436, -86.57769372459589,)}
          >
            <Text style={styles.buttonText2}>Terminal de Buses</Text>
          </TouchableOpacity>
        </View>
