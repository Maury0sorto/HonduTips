...
const locationsData = [
  {
    title: "Taxis Uniplaza",
 
    latitude: 14.031555159183196, 
    longitude: -86.5784852542571,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function PuntoTaxisTerminal() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Punto de Taxis en la Terminal de Buses</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/R03bItL.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/R03bItL.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sáb: 9:00 AM - 2:00 PM </Text>
        </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.031555159183196, -86.5784852542571,)}
          >
            <Text style={styles.buttonText2}>Punto de Taxis</Text>
          </TouchableOpacity>
        </View>
