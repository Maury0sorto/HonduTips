...
const locationsData = [
  {
    title: "Transporte Daniela",
 
    latitude:  14.039200412953164, 
    longitude: -86.57438177640041,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function TransporteDanielaDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Transporte Daniela</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/thycBEi.jpg' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/thycBEi.jpg' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vie: 6:00 AM - 4:00 PM </Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sáb: 6:00 AM - 12:00 PM </Text>
        </View>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/profile.php?id=100077651343944');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.039200412953164, -86.57438177640041,)}
          >
            <Text style={styles.buttonText2}>Transporte Daniela</Text>
          </TouchableOpacity>
        </View>
