...
const locationsData = [
  {
    title: "Alejandras Salon",
 
    latitude:  14.029287110200402, 
    longitude:  -86.56743661178912,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function AlejandrasSalonDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Alejandra's Salon</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sáb: 8:00 AM - 5:00 PM </Text>
        </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.029287110200402, -86.56743661178912,)}
          >
            <Text style={styles.buttonText2}>Alejandras Salon</Text>
          </TouchableOpacity>
        </View>
