...
const locationsData = [
  {
    title: "Sala De Belleza Ibeth",
 
    latitude:     14.028846473214895, 
    longitude:  -86.56910777175875,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function SalaBellezaIbethDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Sala De Belleza Ibeth</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/FfD5n2o.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/FfD5n2o.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sáb: 8:00 AM - 3:00 PM </Text>
        </View>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/profile.php?id=100066690069049');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.028846473214895, -86.56910777175875,)}
          >
            <Text style={styles.buttonText2}>Sala De Belleza Ibeth</Text>
          </TouchableOpacity>
        </View>
