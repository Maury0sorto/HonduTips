...
const locationsData = [
  {
    ...
    latitude:  14.028787321950814, 
    longitude: -86.5782814759292,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function TheBeautyHouseDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>The Beauty House</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/6yGpNTw.png' }} />
              </View>
                 <View style={styles.slide}>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sáb: 9:00 AM - 4:00 PM </Text>
        </View>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.instagram.com/sheybeautyhouse/?igshid=OGQ5ZDc2ODk2ZA%3D%3D');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.028787321950814, -86.5782814759292,)}
          >
            <Text style={styles.buttonText2}>The Beauty House</Text>
          </TouchableOpacity>
        </View>
