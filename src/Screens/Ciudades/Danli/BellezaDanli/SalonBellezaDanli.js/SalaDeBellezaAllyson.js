...
const locationsData = [
  {
    title: "Sala de Belleza Allyson",
 
    latitude:  14.029374172256091,
    longitude:   -86.56879554638329,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function SalaBellezaAllysonDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Sala de Belleza Allyson</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.029374172256091, -86.56879554638329,)}
          >
            <Text style={styles.buttonText2}>Sala de Belleza Allyson</Text>
          </TouchableOpacity>
        </View>
