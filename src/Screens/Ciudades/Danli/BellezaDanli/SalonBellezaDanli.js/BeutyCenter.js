...
const locationsData = [
  {
    ...
    latitude:  14.030369948356347, 
    longitude:  -86.56893763996729,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function BeautyCenterDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Beuty Center</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/2BuWlpp.png' }} />
              </View>
                 <View style={styles.slide}>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/BeautyCenterDanli');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.030369948356347, -86.56893763996729,)}
          >
            <Text style={styles.buttonText2}>Beuty Center</Text>
          </TouchableOpacity>
        </View>
