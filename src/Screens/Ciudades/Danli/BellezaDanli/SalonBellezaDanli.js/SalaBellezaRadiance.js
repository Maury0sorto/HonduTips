...
const locationsData = [
  {
    title: "Sala de Belleza Radiance",
 
    latitude:  14.032511219647704, 
    longitude: -86.56789620353784,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function SalaBellezaRadiance() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Sala de Belleza Radiance</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/hrDVGUQ.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/SiEQzlF.png' }} />
              </View>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.facebook.com/varelajaneth');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(  14.032511219647704, -86.56789620353784,)}
          >
            <Text style={styles.buttonText2}>Sala de Belleza Radiance</Text>
          </TouchableOpacity>
        </View>
