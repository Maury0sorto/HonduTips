...
const locationsData = [
  {
    ...
    latitude:   14.045322615762172, 
    longitude:  -86.56468483243067,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function AshleyNailsDanli() {
...
const images = [
  {
    url: 'https://i.imgur.com/ayUSklf.png',
  },
];
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Ashley Nails</Text>
        <View style={styles.containerSwipers}>
          <View style={styles.swiperContainer}>
            ...
            >
                ...
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/ixFtpl4.png' }} />
              </View>
                 <View style={styles.slide}>
                <Image style={styles.image} source={{ uri: 'https://i.imgur.com/ixFtpl4.png' }} />
              </View>
...
<View style={styles.buttonContainer3}>
  <TouchableOpacity activeOpacity={1} onPress={toggleModal}>
    <Image
      source={{ uri: 'https://i.imgur.com/ayUSklf.png' }}
      style={styles.imagen}
      resizeMode="cover"
    />
  </TouchableOpacity>
...
<Modal visible={modalVisible} animationType="fade" transparent={true}>
  ...
  />
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sáb: 8:00 AM - 6:00 PM </Text>
        </View>
        ...
        <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://ashleynailshn.estaenlanet.com/?fbclid=IwAR3i9gci8vygEhXknXGezjouWK7sUpekXOC99IWKzMIqGgcQ7lzASpp7QCI');
            }}
          >
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps(   14.045322615762172, -86.56468483243067,)}
          >
            <Text style={styles.buttonText2}>Ashley Nails</Text>
          </TouchableOpacity>
        </View>
