...
const locationsData = [
  {
    title: 'Mateos Barber Shop',
    
    latitude:    14.033537392240998, 
    longitude:  -86.57069110812262,
  },
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Mateos Barber Shop</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Dom: 8:00 AM - 7:00 PM</Text>
        </View>
      </View>
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.033537392240998, -86.57069110812262,)}
          >
