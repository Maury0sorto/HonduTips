...
const locationsData = [
  {
    title: 'Barberia Leody',
    
    latitude:   14.034410040141207, 
    longitude:  -86.569593850708466,
  },
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Barberia Leody</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.034410040141207, -86.569593850708466,)}
          >
