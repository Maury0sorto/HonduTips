...
const locationsData = [
  {
    title: 'Gudos Barber Shop',
    
    latitude:  14.031971706747887, 
...
export default function BarberiaGudosDanli() {
  const mapRef = useRef(null);
  const initialRegion = {
    latitude: 14.029878592095196, 
    longitude: -86.57521956355339,
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Gudos Barber Shop</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.031971706747887, -86.56990008652978,)}
          >
            <Text style={styles.buttonText2}>Gudos</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.button2}
            onPress={() => openGoogleMaps( 14.0277416709307, -86.58016601537132,)}
          >
            <Text style={styles.buttonText2}>Gudos Sucursal</Text>
          </TouchableOpacity>
        </View>
