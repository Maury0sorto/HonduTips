...
const locationsData = [
  {
    title: 'Barberia Erick Glamur ',
    
    latitude:    14.030814697330069, 
    longitude:  -86.5776766111407,
  },
  
  // Agrega más ubicaciones aquí si lo deseas
];

export default function BarberiaErickGlamurDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Barberia Erick Glamur</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sáb: 8:00 AM - 7:00 PM</Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Dom: 8:00 AM - 4:00 PM</Text>
        </View>
      </View>
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.030814697330069, -86.5776766111407,)}
          >
            <Text style={styles.buttonText2}>Barberia</Text>
          </TouchableOpacity>
        </View>
