...
const locationsData = [
  {
    title: 'Shadai Master Barber Shop',
    
    latitude:     14.03821648804147, 
    longitude:  -86.5682820352206,
  },
  
  // Agrega más ubicaciones aquí si lo deseas
];

export default function ShadaiMasterBarberShopDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Shadai Master Barber Shop</Text>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vie: 9:00 AM - 8:00 PM</Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sáb: 9:00 AM - 8:00 PM</Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
        ...
        <View style={styles.buttonContainerMapa}>
          <TouchableOpacity
            ...
            onPress={() => openGoogleMaps( 14.03821648804147, -86.5682820352206,)}
          >
            <Text style={styles.buttonText2}>Barberia Shadai</Text>
          </TouchableOpacity>
        </View>
