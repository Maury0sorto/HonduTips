...
const locationsData = [
  {
    ...
    latitude:     14.023426015482142, 
    longitude:   -86.59612433787308,
  },
  {
    title: "Gasolinera PUMA",
    latitude:      14.045825264647274, 
    longitude:   -86.56728522731024,
  },
  {
    title: "Gasolinera PUMA",
    latitude:     14.047240757021267, 
    longitude:   -86.56213538613832,
  },
  {
    title: "Gasolinera PUMA",
    latitude:     14.029870678455747, 
    longitude:   -86.57132536936066, 
  },
...
export default function GasolineraPumaDanli() {
  const mapRef = useRef(null);
  const initialRegion = {
    latitude:   14.036692956121977, 
    longitude:  -86.57665629465794, 
    latitudeDelta: 0.04,
    longitudeDelta: 0.04,
  };
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Gasolinera PUMA</Text>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://pumaenergy.com/es/web/madonna/whoweare/whereweoperate/detailspage?countryName=Honduras&region=1');
            }}
          >
