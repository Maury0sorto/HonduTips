...
const locationsData = [
  {
    title: "Gasolinera Uno",
 
    latitude:    14.041505251118052,
    longitude:   -86.57394759082732,
  },

  {
    title: "Gasolinera Uno",
 
    latitude:    14.016649727844214, 
    longitude:  -86.5698647723188,
  },

  {
    title: "Gasolinera Uno",
 
    latitude:    14.023185704171949,
    longitude:   -86.60242524992432,
  },

  // Agrega más ubicaciones aquí si lo deseas
];

export default function GasolineraUnoDanli() {
  const mapRef = useRef(null);
  const initialRegion = {
    latitude:      14.028026132512695, 
    longitude:   -86.57870176166767,
    latitudeDelta: 0.05,
    longitudeDelta: 0.05,
  };
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Gasolinera UNO</Text>
