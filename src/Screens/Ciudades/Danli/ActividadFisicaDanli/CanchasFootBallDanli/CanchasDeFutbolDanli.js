...
const locationsData = [
  {
    ...
    latitude:    14.042601132353717, 
    longitude:   -86.57037099790118, 
  },

  {
    title: 'Canchita',
 
    latitude:     14.046680676692288, 
    longitude:   -86.57712204298325, 
  },

  {
    title: 'Canchita de fútbol Kora-G',
 
    latitude:    14.022847392759983, 
    longitude:   -86.59695988283536, 
  },

  {
    title: 'Canchita de Plaza San Sebastian',
 
    latitude:    14.032227551489168, 
    longitude:   -86.56898384847335, 
  },
  
  // Agrega más ubicaciones aquí si lo deseas
];

export default function CanchasDeFutbolDanli() {
  const mapRef = useRef(null);
  const initialRegion = {
    latitude:   14.033807648303714,  
    longitude:   -86.57808958603114,
    latitudeDelta: 0.05,
    longitudeDelta: 0.05,
  };
    ...
    <ScrollView>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vie: 12:00 AM - 9:00 PM</Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
          <Text style={styles.scheduleText}>Sáb: Lun-Vie: 12:00 AM - 9:00 PM</Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
