...
const locationsData = [
  {
    ...
    latitude:     14.02822629433259, 
    longitude:  -86.56912136828986,
  },
  
  // Agrega más ubicaciones aquí si lo deseas
];

export default function BetterGymDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Better Body GYM</Text>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vie: 6:12 AM - 2:10 PM</Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
