...
const locationsData = [
  {
    ...
    latitude:    14.031258351084565, 
    longitude:  -86.56539251242292,
  },
  
  // Agrega más ubicaciones aquí si lo deseas
];

export default function GymOlimpoDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>GYM Olimpo</Text>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vie: 5:45 AM - 9:00 PM</Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
