...
const locationsData = [
  {
    title: 'Escuela Municipal De Deporte Danli',
 
    latitude:   14.030880194250404,
    longitude:   -86.56443253991206,
  },
  
  // Agrega más ubicaciones aquí si lo deseas
];

export default function ArtesMarcialesDanli() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title }>Escuela Municipal De Deporte Danli</Text >
