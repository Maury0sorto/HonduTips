...
const locationsData = [
  {
    title: "Farmacia SIMAN #1",
    latitude:     14.030966655433298, 
    longitude:   -86.56982106206561,
  },
  {
    title: "Farmacia SIMAN #2",
    latitude:    14.030750026462947,  
    longitude:   -86.56580852901158,
  },
  {
    title: "Farmacia SIMAN #3",
    latitude:    14.044561278793351,
    longitude:    -86.56797033474605,
  },
...
export default function FarmaciaSimanDanli() {
  const mapRef = useRef(null);
  const initialRegion = {
    latitude:  14.037584876317169, 
    longitude:  -86.56740988715067, 
    latitudeDelta: 0.03,
    longitudeDelta: 0.03,
  };
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Farmacia SIMAN</Text>
      ...
      <View style={styles.scheduleContainer}>
        <View style={styles.scheduleItem}>
          ...
          <Text style={styles.scheduleText}>Lun-Vie: 7:00 AM - 10:00 PM</Text>
        </View>
        <View style={styles.scheduleItem}>
          <Icon name="clock-o" size={20} color="#000" style={styles.scheduleIcon} />
