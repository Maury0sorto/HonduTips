...
const locationsData = [
  {
    title: "Farmacia EL AHORRO",
    latitude:      14.031099546607022, 
    longitude:   -86.56956070049195,
  },
  {
    title: "Farmacia EL AHORRO",
    latitude:    14.03290635602841, 
    longitude:   -86.57305795119629,
  },
  {
    title: "Farmacia EL AHORRO",
    latitude:     14.028164166511742, 
    longitude:    -86.57941412895535,
  },
...
export default function FarmaciaElAhorroDanli() {
  const mapRef = useRef(null);
  const initialRegion = {
    latitude:  14.030933133066753, 
    longitude:  -86.57591839551597, 
    latitudeDelta: 0.02,
    longitudeDelta: 0.02,
  };
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Farmacia EL AHORRO</Text>
      ...
      <View style={styles.scheduleContainer}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://www.farmaciasdelahorro.hn/#/');
            }}
          >
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Linking.openURL('https://api.whatsapp.com/send/?phone=50494391717&text=Buenas+Farmacias+del+Ahorro&type=phone_number&app_absent=0');
            }}
          >
